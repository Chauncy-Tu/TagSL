...
dwt_time_units=1/499.2/128*1e-6;
Agent.tdoa_(:,3)=Agent.tdoa_(:,3)/dwt_time_units;
...
%     ri1(i)=c*((Agent.rxtime_buffer_(i+1)-Agent.rxtime_buffer_(1))-Agent.cfo_(i+1)*Agent.t_reply_(i+1))-norm(Agent.pos_buffer_(i+1,:)-Agent.pos_buffer_(1,:));
    ...
    ri1(i)=c*Agent.tdoa_(i,3)*dwt_time_units-norm(Agent.map_(Agent.tdoa_(i,1),:)-Agent.map_(Agent.tdoa_(i,2),:));
